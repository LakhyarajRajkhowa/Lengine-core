...
namespace Lengine {
    ...
    public:
        ...
        // ---------------------------------------------------------
        // View — iterates the SMALLEST storage among T... and
        // checks the rest via Has(), avoiding iterating large sets
        // when a rare component is involved.
        //
        // Usage:
        ...
        std::vector<Entity> View() const
        {
            ...
            // so we iterate the shortest list and check membership in the rest
            size_t minSize = std::min({ StorageSize<Ts>()... });

            // Pick whichever storage is smallest and walk it
    ...
    private:
        ...
        // Returns the dense size of a given storage
        ...
        {
            // If this storage is the smallest one, iterate its entity list
    ...
    // ---------------------------------------------------------
    // GetStorageEntities specialisations
    // ---------------------------------------------------------
